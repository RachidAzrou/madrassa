          ...
          {effectiveBreadcrumbs && (
            <div className="text-xs text-white opacity-70 flex items-center">
              {effectiveBreadcrumbs.parent && (
                <>
                  <span className="mr-1">{effectiveBreadcrumbs.parent === "Onderwijs" ? "Onderwijs" : (effectiveBreadcrumbs.parent === "Administratie" ? "Evaluatie" : effectiveBreadcrumbs.parent)}</span>
