      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-tr from-blue-100 via-white to-blue-50 dark:from-slate-900 dark:via-slate-800 dark:to-slate-700">
          <div className="absolute inset-0 overflow-hidden" style={{
            backgroundImage: 'url("https://raw.githubusercontent.com/user-attachments/assets/main/rm347-porpla-02-a-01.jpg")',
            backgroundSize: 'cover',
            backgroundRepeat: 'repeat',
            backgroundPosition: 'center',
            filter: 'brightness(1.05) hue-rotate(-10deg) opacity(0.15) contrast(0.9) sepia(0.2) saturate(0.9)',
          }}>
            <div className="absolute inset-0" style={{ backgroundColor: '#3b5998', mixBlendMode: 'color', opacity: 0.2 }}></div>
          </div>
        </div>
