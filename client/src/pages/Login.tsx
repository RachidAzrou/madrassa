...
import schoolDoodlesBg from '@assets/2592039_1749463804244.jpg';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* School doodles background image */}
      <div 
      ...
      {/* MyMadrassa blue color overlay to match brand */}
      <div 
        className="absolute inset-0"
        style={{
          background: 'linear-gradient(135deg, rgba(74, 111, 165, 0.85) 0%, rgba(90, 123, 196, 0.8) 50%, rgba(107, 141, 214, 0.75) 100%)'
        }}
      ></div>

      {/* Subtle glow effects to maintain depth */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-0 w-96 h-96 bg-gradient-to-br from-[#4A6FA5]/20 to-[#2563eb]/15 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-gradient-to-tl from-[#5A7BC4]/15 to-[#4A6FA5]/20 rounded-full blur-3xl"></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-72 h-72 bg-gradient-to-r from-[#6B8DD6]/10 to-[#4A6FA5]/15 rounded-full blur-2xl"></div>
      </div>
      {/* Centered login form */}
