        ...
        <div className="rounded-lg overflow-hidden shadow-sm">
          <div className="bg-gradient-to-r from-[#1e3a8a] to-[#1e40af] p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-bold text-white">Klassen</h1>
                <p className="text-base text-blue-100 mt-1">Beheer klassen, secties en activiteitengroepen</p>
              </div>
            </div>
          </div>
        </div>
